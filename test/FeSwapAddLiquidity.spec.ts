  ...
  const provider = new MockProvider({
    ...
    describe( " Add Liquidity: Token A || Token B", () => {
      ...
      it('Add Liquidity GAS usage： Single Pool ', async () => {
        ...
        expect(receipt.gasUsed).to.eq("230326")    // 230346 230981 230988 232632 232639 232654 232683  232618 233577 234377 234456 236182 236131 236108 238676 238686, 228994  Uniswap 213957
      })
      ...
      it('Add Liquidity GAS usage： Double Pool ', async () => {
        ...
        const receipt = await tx.wait()
        expect(receipt.gasUsed).to.eq("427060")    // 427093 428358 428365  431658 431665 431702 431753 431623 433541 435141 435299 438763 438668 438622 443746 443722, 425406
      })
    })
